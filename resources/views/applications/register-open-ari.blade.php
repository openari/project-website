...
<div class="page-wrapper">
    <div class="checkout-area-wrapper mt-120 mt-md-80 mt-sm-60 mb-120 mb-md-80 mb-sm-60">
        <div class="container">
            ...
            <div class="row">
                <form action="{{ action('ApplicationController@store') }}" method="post">
                    {{ csrf_field() }}
                    ...
                    <!-- Checkout Form Area Start -->
                            <div class="billing-form-wrap">
                                <div class="single-input-item">
                                        <label for="applicant" class="required">申請人姓名/單位</label>
                                        <input type="text" id="applicant" name="applicant" placeholder="Applicant" value="{{ old('applicant') }}" required/>
                                </div>
                                <div class="single-input-item">
