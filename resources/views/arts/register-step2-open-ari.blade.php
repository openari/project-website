                ...
                <div class="col-lg-8">
                            <div class="billing-form-wrap">
                                <div class="single-input-item">
                                    <label for="ordernote">關於物件的說明</label>
                                    <textarea name="ordernote" id="ordernote" cols="120" rows="6"
                                              placeholder="藝術品的簡易說明：物品屬於何類？（如，繪畫、雕刻、時鐘、面具等）"></textarea>
                                </div>
                            </div>
                                ...
                                <div class="proceed-checkout-btn m-2 float-left">
                                    <a href="{{ url('/register-step3-open-ari') }}" class="btn btn-brand">下一步</a>
                                </div>
                 </div>
