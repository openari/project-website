                    ...
                    <div class="col-12">
                        <div class="checkout-page-coupon-area">
                            ...
                            <div class="checkoutAccordion">
                                <div class="card">
                                    <h3 class="float-left">作品碼：{{ $art->id }} |  作品碼連結：<a href="{{ action('ArtController@show', [ 'artId' => $art->id, 'part' => 'identification' ]) }}">{{ action('ArtController@show', [ 'artId' => $art->id, 'part' => 'identification' ]) }}</a></h3>
                                </div>
                            </div>
