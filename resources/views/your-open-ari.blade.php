        ...
        <div class="container">
            <div class="row">
                 <div class="checkout-billing-details-wrap col-lg-12">
                        <h3><strong> 你的作品碼已完成登入</strong></h3>
                        <div>你已經申請完成，可直接查閱作品名冊</div>
                    </div>
                <div class="col-lg-4">
                            <!-- Start Single Portfolio -->
                                ...
                                <div class="single-portfolio-wrap layout--2">
                                    <figure class="portfolio-thumb">
                                        <img src="assets/img/portfolio/portfolio_03.jpg" alt="Portfolio Image"/>
                                        <a href="#" class="btn-view-work"><i class="fa fa-link"></i></a>
                                    </figure>
                                </div>
                </div>
                            <div class="col-md-8">
                                <div class="single-portfolio-wrap layout--2">
                                    <div class="portfolio-details">
                                            <h3>標題</h3>
                                            <nav class="portfolio-cate">製作者</nav>
                                        <div class="portfolio-details">
                                            <nav class="portfolio-cate">簡述</h3>
                                                Aenean lacinia bibendum nulla sed consectetur. Cras justo odio, dapibus ac facilisis in, egestas eget quam.
                                            </nav>
                                        </div>
                                    </div>
                                </div>
                                <div class="single-portfolio-wrap proceed-checkout-btn">
                                            <a href="{{ url('/') }}" class="btn btn-black">回首頁</a>
                                </div>
                            </div>
